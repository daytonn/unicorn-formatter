...
Gem::Specification.new do |s|
  ...
  s.files = Dir.glob("#{File.expand_path(File.dirname(__FILE__))}/**/*").reject { |f| f.match(/pkg/) }
  s.homepage = "http://github.com/daytonn/unicorn-formatter"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.23"
  s.summary = "A majestic unicorn will leap across your screen when your specs pass"
